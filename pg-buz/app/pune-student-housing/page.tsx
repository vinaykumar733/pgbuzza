...
export default function PuneStudentHousing() {
  return (
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            <Link href="/" className="hover:text-premium-gold">Home</Link>
            <span>›</span>
            <span className="text-navy-dark">Pune Student Housing</span>
          </div>
          <h1 className="text-4xl font-bold text-navy-dark mb-4">Pune Student Housing & PG Market</h1>
          <p className="text-xl text-gray-600 max-w-3xl">Latest updates on student housing, PG demand, and investment opportunities in Pune.</p>
        </div>
      </section>
