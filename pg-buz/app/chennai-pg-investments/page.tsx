...
export default function ChennaiPGInvestments() {
  return (
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            <Link href="/" className="hover:text-premium-gold">Home</Link>
            <span>›</span>
            <span className="text-navy-dark">Chennai PG Investments</span>
          </div>
          <h1 className="text-4xl font-bold text-navy-dark mb-4">Chennai PG Investment Opportunities</h1>
          <p className="text-xl text-gray-600 max-w-3xl">Explore PG investment opportunities and market insights in Chennai.</p>
        </div>
      </section>
